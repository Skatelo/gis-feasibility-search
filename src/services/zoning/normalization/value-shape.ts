...
const PLACEHOLDER_RE = /^(city|county|etj|none|n\/?a|null|mun\.?|muni|municipal|municipality|split|unknown|not applicable|unzoned|tbd|unavailable|unresolved|not published|not found|official map review|manual review|zoning code unresolved|no adopted district|land use:.+)$/i;
